...
comp.addEventListener('mouseover', () => {
    ...
    para.innerHTML = "<ul id='ulu'> <li>Decouper et intégrer une maquete graphique en HTML 5.</li><li>Realiser des interfaces web statique et adaptable en respectant les standars du web et les normes en vigeur.</li><li>Utilisation du prépocessur CSS:SASS</><li>Optimiser le référencement naturel.</li><li>Utiliser les outils de versionnig git et github pour gerer mon code source.</li><li>Maitrise partiel du librairies React</li><li>Musicien de formation/Pianiste</li></ul>";
